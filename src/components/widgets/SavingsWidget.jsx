/**
 * VaultAudit AI — SavingsWidget
 *
 * Donut chart showing savings progress with gradient fill.
 * Includes goal target and monthly delta cards.
 */
      ...
      <div className="flex items-center gap-6 relative">
        ...
        <div className="relative w-[180px] h-[180px] shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <div
              className="mt-1 text-white tracking-tight"
              style={{ fontSize: 28 }}
            >
